...
def main():
    ...
    cmd = [
        ...
        # "--windowed",  # No console window (disabled for debugging)
    ...
    release_dir = project_root / "release" / "Askit."
    ...
    exe_file = dist_dir / "Askit..exe"
    if exe_file.exists():
        shutil.copy(exe_file, release_dir / "Askit..exe")
        print(f"  Copied: Askit..exe")

    # Create distribution archive
    print("\n[4/4] Creating distribution archive...")
    archive_path = project_root / "release" / "Askit.-release"
    shutil.make_archive(
        str(archive_path),
        "zip",
    ...
    print(f"  Created: Askit.-release.zip")
